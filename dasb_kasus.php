...
$data = query("SELECT * FROM db_user");
?>
<!DOCTYPE html>
<html lang="en">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($data as $user) : ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="hapus_user.php?id_user=<?= $user["id_user"]; ?>" onclick="return confirm('Apakah Anda Yakin Menghapus User Ini?')"><button class="btn btn-danger">Hapus</button></a>
