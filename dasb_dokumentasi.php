...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="dasb_index.php">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php foreach ($data_gambar as $foto) : ?>
                                            <?php $no = 1 ?>
                                            <tr>
                                                <th><?= $no ?></th>
                                                <th><img src="img/gambarkasus/<?= $foto["nama_foto"] ?>" alt="" width="200px"></th>
                                                <th><?= $foto["title_foto"] ?></th>
                                                <th><?= $foto["desc_foto"] ?></th>
                                                <th>
                                                    <a href="hapus_foto.php?id_foto=<?= $foto["id_foto"]; ?>" onclick="return confirm('Apakah Anda Yakin Menghapus Data Ini?')"><button class="btn btn-danger">Hapus</button></a> |
                                                    <a href="ubah_dok.php?id_foto=<?= $foto["id_foto"]; ?>"><button class="btn btn-warning">Ubah</button></a>
                                                </th>
                                            </tr>
                                            <?php $no++ ?>
                                        <?php endforeach; ?>
                                ...
                                <a href="tambah_dok.php"><button class="btn btn-primary">Tambah Data</button></a>
                            </div>
                        </div>
                    </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Full Senyum 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
