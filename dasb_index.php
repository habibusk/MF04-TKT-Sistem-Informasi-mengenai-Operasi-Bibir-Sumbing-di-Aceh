...
$data_kasus = query("SELECT * FROM db_kasus");
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php foreach ($data_kasus as $kasus) : ?>
                                            <?php $no = 1 ?>
                                            <tr>
                                                <th><?= $no ?></th>
                                                <th><img src="img/gambarkasus/<?= $kasus["foto_pasien"] ?>" alt="" width="200px"></th>
                                                <th><?= $kasus["nama_pasien"] ?></th>
                                                <th><?= $kasus["alamat_pasien"] ?></th>
                                                <th><?= $kasus["umur_pasien"] ?></th>
                                                <th><?= $kasus["deskripsi_kasus"] ?></th>
                                                <th>
                                                    <a href="hapus_kasus.php?id_kasus=<?= $kasus["id_kasus"]; ?>" onclick="return confirm('Apakah Anda Yakin Menghapus Data Ini?')"><button class="btn btn-danger">Hapus</button></a> |
                                                    <a href="ubah_kasus.php?id_kasus=<?= $kasus["id_kasus"]; ?>"><button class="btn btn-warning">Ubah</button></a>
                                                </th>
                                            </tr>
                                            <?php $no++ ?>
                                        <?php endforeach; ?>
